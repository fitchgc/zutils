...
var require_utils = __commonJS({
  "node_modules/@noble/hashes/utils.js"(exports2) {
    ...
    exports2.wrapXOFConstructorWithOpts = wrapXOFConstructorWithOpts2;
...
var require_lib3 = __commonJS({
  "node_modules/web3-eth-abi/lib/index.js"(exports2, module2) {
...
var sign = async ({
  ...
  const web3 = new import_web3.default();
...
function checkPersionalSign(message, address, signature) {
  ...
  const recovered = (0, import_eth_sig_util2.recoverPersonalSignature)({ data: message, signature });
