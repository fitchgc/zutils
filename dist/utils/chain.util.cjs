...
function recoverTypedSignatureV4(signObj, signature) {
  return (0, import_ethers.verifyTypedData)(signObj.domain, signObj.types, signObj.message, signature);
}
...
function checkPersionalSign(message, address, signature) {
  ...
  const recovered = (0, import_ethers.verifyMessage)(message, signature);
